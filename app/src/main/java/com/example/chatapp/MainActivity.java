    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //String dateTime = "10:00 AM";
                db.child("Messages").push().setValue(new Chat(uEmail,msg,timeStamp)).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
        ...
        db.child("Messages").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot snap:snapshot.getChildren()){
                    Chat message = snap.getValue(Chat.class);
